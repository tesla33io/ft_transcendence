...
export class GameBoard {
	...
	public renderGameState(state: any) {
		...
		const scoreTag = `${opponent.name} ${opponent.score} | ${player.score} ${player.name}`
		this.gameBoard.setContent(scoreTag)
		...
		grid[ballPos.scaledY][ballPos.scaledX] = '□';  // Ball's position
